...
class ExampleStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExampleMethod = channel.unary_unary(
                ...
                request_serializer=greet__pb2.ExampleRequest.SerializeToString,
                response_deserializer=greet__pb2.ExampleReply.FromString,
...
def add_ExampleServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExampleMethod': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=greet__pb2.ExampleRequest.FromString,
                    response_serializer=greet__pb2.ExampleReply.SerializeToString,
            ),
    }
...
class Example(object):
    ...
    def ExampleMethod(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/example.Example/ExampleMethod',
            greet__pb2.ExampleRequest.SerializeToString,
            greet__pb2.ExampleReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
